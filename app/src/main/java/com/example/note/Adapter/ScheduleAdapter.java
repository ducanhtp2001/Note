...
//
//        tv_tenMon.setText(schedule.tenMon);
//        tv_soTinChi.setText("Số tín chỉ: " + schedule.soTinChi);
//        tv_maMon.setText("" + schedule.maMon);
//        tv_lopTinChi.setText("L0" + schedule.lopTinChi);
//        tv_phongHoc.setText(schedule.phongHoc);
//        tv_caHoc.setText("Ca " + schedule.caHoc);
